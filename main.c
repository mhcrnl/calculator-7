...
int main(int argc, char *argv[])
{
 a = 0;
 b = 0;        /*初始化两个参与运算的变量为零*/
 hasdot = 0;   /*小数点标识为0， 即默认不带小数点*/
 gtk_set_locale ();
 gtk_rc_add_default_file("./gtkrc.zh_CN"); /*支持GTK+的中文显示*/
 ...
 table2 = gtk_table_new (5, 9, FALSE);
...
button14 = gtk_button_new_with_mnemonic("7");             /*数字按钮7*/
